    ...
    <?php if ($result->num_rows > 0): ?>
        <?php while($row = $result->fetch_assoc()): ?>
            ...
            <div class="wisata-card">
                <img src="<?= htmlspecialchars($gambar) ?>" alt="Gambar <?= htmlspecialchars($row['nama_wisata']) ?>" onerror="this.onerror=null;this.src='https://placehold.co/600x400/e2e8f0/e2e8f0?text=Error';">
